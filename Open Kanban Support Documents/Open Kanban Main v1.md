...
4. Freedom to benefit the entire Open Kanban community with a better solution for all, by encouraging and adopting the changes and contributions the community itself gives back to the [root repository](https://github.com/agilelion/Open-Kanban) of Open Kanban on GitHub. This freedom shows our commitment to communication, collaboration and continuous improvement (freedom 4.)
